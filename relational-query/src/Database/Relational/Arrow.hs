...
type AssignStatement p r a = QueryA (Monadic.ReadPlaceholders p (Monadic.Assign r)) (Record Flat r) a

-- | Arrow type corresponding to 'Monadic.Register'
type Register p r a = QueryA (Monadic.Register p r) () a

-- | Arrow type corresponding to 'Monadic.RestrictedStatement'
type RestrictedStatement p r a = QueryA (Monadic.ReadPlaceholders p Monadic.Restrict) (Record Flat r) a
